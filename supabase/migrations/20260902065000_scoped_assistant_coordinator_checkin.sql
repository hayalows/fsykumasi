-- Assistant Coordinators can record arrival only for participants in companies
-- they can access. Session-wide leaders retain whole-session check-in access.
...
begin
  if not (
    ...
    raise exception 'Your role cannot record check-in for this participant';
  end if;
