-- Fix website-access setup rejecting normal email addresses after the live AC reassignment migration.
-- PostgreSQL's standard-conforming strings preserve backslashes. The v79 validator used
-- two backslashes before the dot, so ordinary addresses such as name@gmail.com failed.
-- Use a character class for the literal dot to avoid string/regex escaping ambiguity.
