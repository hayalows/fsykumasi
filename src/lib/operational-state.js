...
export const updateStaffOperations=(person,state)=>rpc('update_staff_operations',{
 p_staff_id:person.id,p_revision:person.operationsRevision,p_planning:state.planning,p_arrival:state.arrival,p_clearance:state.clearance,p_authority:state.authority||'',p_reason:state.reason||'',p_duties:state.duties||[]
});
