...
export function Registration(props) {
  ...
  return <div className="registration-enhanced registration-workspace registration-workspace-v5 registration-unified registration-v10 registration-v21 registration-v28">
    ...
    <div className="registration-workspace-pane registration-workspace-pane-v5 registration-unified-pane">
      {mode !== "setup" ? <div role="tabpanel" aria-labelledby={mode === "desk" ? "registration-mode-desk" : "registration-mode-roster"}>
        <RegistrationJourney view={mode} participants={imported} initialFilter={initialFilter} sessionId={sessionId} setImported={props.setImported} capabilities={capabilities} onOperationalDataChanged={onOperationalDataChanged} />
      </div> : <div role="tabpanel" aria-labelledby="registration-mode-setup" className="registration-setup-shell">
        <div className="registration-setup-nav-wrap">
          <SegmentedControl
            ...
            options={[
              ...
              { value: "identity", label: "FSY identities", id: "registration-setup-identity" },
