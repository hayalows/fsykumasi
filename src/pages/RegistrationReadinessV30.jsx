...
export function RegistrationReadinessV30({
  ...
  return <section className="registration-readiness-v30" aria-busy={loading}>
    ...
    <p className="registration-readiness-principle-v30"><CheckCircle size={18} weight="fill" /><span><b>One final participant list.</b> Final roster holds the remaining youth decisions. Readiness checks the supporting setup and points to the next place to work.</span></p>
  </section>;
}
