...
export function Food({ sessionId, currentRole = "", capabilities = [], sessionName, participants = [], live = false, initialTab = "", initialFilter = "" }) {
  ...
  const voidMeal = async (event) => {
    ...
    if (!selectedService || !canVoid || voidReason.trim().length < 5) return;
