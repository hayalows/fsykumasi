...
export function App() {
  ...
  const content=effectiveActive==="overview"?<Overview currentRole={currentRole} currentUser={profile} headcount={headcount} setActive={navigate} imported={operationalParticipants} allParticipants={participants} cohort={cohort} assignment={assignment} pendingAccess={pendingAccess} birthdays={[...birthdays,...staffBirthdays]} live={live} companies={companies} checkedCount={operationalCheckedIds.length} sessionName={sessionName} capabilities={currentCapabilities} fieldSummary={fieldSummary}/>
